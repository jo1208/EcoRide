...
VALUES ('admin@ecoride.fr', '["ROLE_ADMIN"]', 'adminpass', 'Admin', 'User', '0101010101', '1 rue du test', '1990-01-01', 'admino', FALSE, FALSE, TRUE, 5.0, 50),
('employe@ecoride.fr', '["ROLE_EMPLOYE"]', 'employepass', 'Jean', 'Dupont', '0202020202', '2 avenue dev', '1992-05-10', 'jeanjean', FALSE, TRUE, TRUE, 4.5, 40),
('user@ecoride.fr', '["ROLE_USER"]', 'userpass', 'Marie', 'Durand', '0303030303', '3 boulevard code', '1995-09-25', 'mariedu', FALSE, FALSE, TRUE, 4.2, 30);
